...
static void mavlink_test_paotou_mavlink(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PAOTOU_MAVLINK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_paotou_mavlink_t packet_in = {
        5,72,139,206,17,84,151,218,29,96
    };
    mavlink_paotou_mavlink_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.enable = packet_in.enable;
        packet1.qian = packet_in.qian;
        packet1.hou = packet_in.hou;
        packet1.zuo = packet_in.zuo;
        packet1.you = packet_in.you;
        packet1.tongdao1 = packet_in.tongdao1;
        packet1.tongdao2 = packet_in.tongdao2;
        packet1.tongdao3 = packet_in.tongdao3;
        packet1.tongdao4 = packet_in.tongdao4;
        packet1.all = packet_in.all;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PAOTOU_MAVLINK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PAOTOU_MAVLINK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_paotou_mavlink_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_paotou_mavlink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_paotou_mavlink_pack(system_id, component_id, &msg , packet1.enable , packet1.qian , packet1.hou , packet1.zuo , packet1.you , packet1.tongdao1 , packet1.tongdao2 , packet1.tongdao3 , packet1.tongdao4 , packet1.all );
    mavlink_msg_paotou_mavlink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_paotou_mavlink_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.enable , packet1.qian , packet1.hou , packet1.zuo , packet1.you , packet1.tongdao1 , packet1.tongdao2 , packet1.tongdao3 , packet1.tongdao4 , packet1.all );
    mavlink_msg_paotou_mavlink_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_paotou_mavlink_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_paotou_mavlink_send(MAVLINK_COMM_1 , packet1.enable , packet1.qian , packet1.hou , packet1.zuo , packet1.you , packet1.tongdao1 , packet1.tongdao2 , packet1.tongdao3 , packet1.tongdao4 , packet1.all );
    mavlink_msg_paotou_mavlink_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("PAOTOU_MAVLINK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_PAOTOU_MAVLINK) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_paotou_mavlink(system_id, component_id, last_msg);
